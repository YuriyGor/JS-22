...
//     функцию как рез-т своей работы называется "функцией высшего порядка"
...
const callback = function () {
    console.log(`Через 3с внутри колбэка в таймауте`);
}
...
// 3. если элемент массива НЕ удовлетворяет условию, то функция верне false
